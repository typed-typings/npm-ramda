...
// @dts-jest:pass -> (v1: string, v2: number) => number
R_cond([
  [string_to_boolean, string_to_number],
  [string_number_to_boolean, string_to_number],
]);

// @dts-jest:fail -> Argument of type '([(a: string, b: number) => boolean, Morphism<string, number>] | [Morphism<string, boolean>, (a: ...' is not assignable to parameter of type '[(v1: string, v2: number, v3: {}, v4: {}, v5: {}, v6: {}) => boolean, (v1: string, v2: number, v3...'.
R_cond([
