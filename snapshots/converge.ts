...
// @dts-jest:pass -> <T1>(fns: [(v1: T1) => string, (v1: T1) => number, (v1: T1) => boolean]) => CurriedFunction1<T1, object>
...
// @dts-jest:pass -> <T1>(fns: [(v1: T1) => any]) => CurriedFunction1<T1, object>
R_converge(any_args_to_object);
// @dts-jest:pass -> <T1, T2>(fns: [(v1: T1, v2: T2) => any, (v1: T1, v2: T2) => any]) => CurriedFunction2<T1, T2, object>
