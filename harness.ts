// source: 'typescript/src/harness/harness.ts'
import * as ts from 'typescript';
// import * as ts from 'typescript/src/compiler';
...
/// <reference path='typescript\src\services\services.ts' />
/// <reference path='typescript\src\services\shims.ts' />
/// <reference path='typescript\src\server\session.ts' />
/// <reference path='typescript\src\server\client.ts' />
/// <reference path='typescript\src\harness\sourceMapRecorder.ts'/>
/// <reference path='typescript\src\harness\runnerbase.ts'/>
/// <reference path='typescript\src\harness\virtualFileSystem.ts' />
