...
type propOr_000 = {
    ...
    <$SEL extends "101", $KIND extends "general">(): <T>(defaults: T, _key: PH, object: {}) => propOr_general_101<T>;
    ...
    <$SEL extends "111", $KIND extends "general">(): <T, U>(defaults: T, key: Property, object: {}) => propOr_general_111<T, U>;
...
type propOr_general_100<T> = {
    ...
    <$SEL extends "01">(): (_key: PH, object: {}) => propOr_general_101<T>;
    <$SEL extends "11">(): <U>(key: Property, object: {}) => propOr_general_111<T, U>;
...
type propOr_general_010 = {
    ...
    <$SEL extends "11">(): <T, U>(defaults: T, object: {}) => propOr_general_111<T, U>;
