...
declare function $<R1, R2, R3>(fn1: () => PromiseLike<R1> | R1, fn2: (v: R1) => PromiseLike<R2> | R2, fn3: (v: R2) => PromiseLike<R3> | R3): () => PromiseLike<R3>;
...
declare function $<R1, R2, R3, R4>(fn1: () => PromiseLike<R1> | R1, fn2: (v: R1) => PromiseLike<R2> | R2, fn3: (v: R2) => PromiseLike<R3> | R3, fn4: (v: R3) => PromiseLike<R4> | R4): () => PromiseLike<R4>;
...
declare function $<R1, R2, R3, R4, R5>(fn1: () => PromiseLike<R1> | R1, fn2: (v: R1) => PromiseLike<R2> | R2, fn3: (v: R2) => PromiseLike<R3> | R3, fn4: (v: R3) => PromiseLike<R4> | R4, fn5: (v: R4) => PromiseLike<R5> | R5): () => PromiseLike<R5>;
...
declare function $<R1, R2, R3, R4, R5, R6>(fn1: () => PromiseLike<R1> | R1, fn2: (v: R1) => PromiseLike<R2> | R2, fn3: (v: R2) => PromiseLike<R3> | R3, fn4: (v: R3) => PromiseLike<R4> | R4, fn5: (v: R4) => PromiseLike<R5> | R5, fn6: (v: R5) => PromiseLike<R6> | R6): () => PromiseLike<R6>;
