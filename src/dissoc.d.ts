...
type dissoc_00 = {
    ...
    <$SEL extends "01", $KIND extends "keyof">(): <T extends {}>(_property: PH, object: T) => dissoc_keyof_01<T>;
    <$SEL extends "01", $KIND extends "record">(): <U extends Record<V, any>, V extends string>(_property: PH, object: U) => dissoc_record_01<U, V>;
    <$SEL extends "01", $KIND extends "general">(): <T extends {}>(_property: PH, object: T) => dissoc_general_01<T>;
