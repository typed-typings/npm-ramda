...
type dissoc_00 = {
    ...
    <V extends PropertyKey>(property: V): dissoc_record_10<V>;
    (property: Property): dissoc_general_10;
    <T extends object>(_property: PH, object: T): dissoc_keyof_01<T>;
    <U extends Record<V, any>, V extends PropertyKey>(_property: PH, object: U): dissoc_record_01<U, V>;
    ...
    <U extends Record<V, any>, V extends PropertyKey>(property: V, object: U): dissoc_record_11<U, V>;
    <$SEL extends "11", $KIND extends "general">(): <T extends object>(property: Property, object: T) => dissoc_general_11<T>;
    <$SEL extends "11", $KIND extends "record">(): <U extends Record<V, any>, V extends PropertyKey>(property: V, object: U) => dissoc_record_11<U, V>;
    ...
    <$SEL extends "01", $KIND extends "record">(): <U extends Record<V, any>, V extends PropertyKey>(_property: PH, object: U) => dissoc_record_01<U, V>;
    ...
    <$SEL extends "1", $KIND extends "record">(): <V extends PropertyKey>(property: V) => dissoc_record_10<V>;
...
type dissoc_record_10<V extends PropertyKey> = {
...
type dissoc_record_01<U extends Record<V, any>, V extends PropertyKey> = {
...
type dissoc_record_11<U extends Record<V, any>, V extends PropertyKey> = Omit<U, V>;
