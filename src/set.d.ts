...
type set_number_001<U extends {
    ...
    <$SEL extends "01">(): <N extends number>(_lens: PH, value: U[NumberToString[N]]) => set_number_011<N, U>;
    <$SEL extends "11">(): <N extends number>(lens: PseudoLens<N>, value: U[NumberToString[N]]) => set_number_111<U>;
