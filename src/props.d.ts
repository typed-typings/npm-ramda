...
P4 extends string & keyof O,
P5 extends string & keyof O,
P6 extends string & keyof O,
P7 extends string & keyof O,
...
P4 extends string & keyof O,
P5 extends string & keyof O,
O extends {[K in P1 | P2 | P3 | P4 | P5]: any}>
(ps: [P1, P2, P3, P4, P5], obj: O): 
...
P3 extends string & keyof O,
P4 extends string & keyof O,
O extends {[K in P1 | P2 | P3 | P4]: any}>
(ps: [P1, P2, P3, P4], obj: O): 
[O[P1], O[P2], O[P3], O[P4]]
