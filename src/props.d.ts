...
type props_00 = {
    ...
    <T extends {}>(_keys: PH, object: T): props_keyof_01<T>;
    ...
    <$SEL extends "01", $KIND extends "keyof">(): <T extends {}>(_keys: PH, object: T) => props_keyof_01<T>;
    <$SEL extends "01", $KIND extends "record">(): <K extends string, T extends Record<K, any>>(_keys: PH, object: T) => props_record_01<K, T>;
    <$SEL extends "01", $KIND extends "general">(): (_keys: PH, object: {}) => props_general_01;
