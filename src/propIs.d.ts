...
type propIs_000 = {
    ...
    <$SEL extends "101", $KIND extends "guard">(): <T, U extends {}>(constructor: Constructor<T>, _key: PH, object: U) => propIs_guard_101<T, U>;
    <$SEL extends "011", $KIND extends "general">(): (_constructor: PH, key: Property, object: {}) => propIs_general_011;
    <$SEL extends "011", $KIND extends "guard">(): <U extends {}, K extends string>(_constructor: PH, key: K, object: U) => propIs_guard_011<U, K>;
    <$SEL extends "001", $KIND extends "general">(): (_constructor: PH, _key: PH, object: {}) => propIs_general_001;
    <$SEL extends "001", $KIND extends "guard">(): <U extends {}>(_constructor: PH, _key: PH, object: U) => propIs_guard_001<U>;
...
type propIs_guard_100<T> = {
    ...
    <$SEL extends "01">(): <U extends {}>(_key: PH, object: U) => propIs_guard_101<T, U>;
...
type propIs_guard_010<K extends string> = {
    ...
    <$SEL extends "01">(): <U extends {}>(_constructor: PH, object: U) => propIs_guard_011<U, K>;
