...
type propSatisfies_000 = {
    ...
    <$SEL extends "01", $KIND extends "keyof">(): <T extends {}, K extends keyof T>(_fn: PH, key: K) => propSatisfies_keyof_010<T, K>;
    ...
    <$SEL extends "001", $KIND extends "keyof">(): <T extends {}>(_fn: PH, _key: PH, object: T) => propSatisfies_keyof_001<T>;
    ...
    <$SEL extends "001", $KIND extends "general">(): (_fn: PH, _key: PH, object: {}) => propSatisfies_general_001;
    <$SEL extends "011", $KIND extends "keyof">(): <T extends {}, K extends keyof T>(_fn: PH, key: K, object: T) => propSatisfies_keyof_011<T, K>;
    ...
    <$SEL extends "011", $KIND extends "general">(): (_fn: PH, key: Property, object: {}) => propSatisfies_general_011;
    <$SEL extends "101", $KIND extends "keyof">(): <T extends {}, K extends keyof T>(fn: Predicate<T[K]>, _key: PH, object: T) => propSatisfies_keyof_101<T, K>;
    ...
    <$SEL extends "101", $KIND extends "general">(): <V>(fn: Predicate<V>, _key: PH, object: {}) => propSatisfies_general_101<V>;
...
type propSatisfies_general_100<V> = {
    ...
    <$SEL extends "01">(): (_key: PH, object: {}) => propSatisfies_general_101<V>;
...
type propSatisfies_general_010 = {
    ...
    <$SEL extends "01">(): (_fn: PH, object: {}) => propSatisfies_general_011;
